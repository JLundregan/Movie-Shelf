...
//This is for the informational text at the bottom
// pageInfo = document.getElementById('movie-count');
// count = document.createElement('h3');
// count.textContent = "You have " + movieCount + " movies on your shelf";
// pageInfo.appendChild(count)
...
function makeHTML(movieObject) {
  ...
  //Checks if the user has marked the movie as seen
  if(movieObject.seen){
